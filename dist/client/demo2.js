...
//  cubes
for (var i = 0; i < 20; i++) {
    const grabable = new THREE.Mesh(new THREE.BoxBufferGeometry(1.0, 1.0, 1.0), new THREE.MeshBasicMaterial({
        color: 0xff0066,
        wireframe: true
    }));
...
//  spheres
for (var i = 0; i < 20; i++) {
    const grabable = new THREE.Mesh(new THREE.SphereGeometry(.5, 6, 6), new THREE.MeshBasicMaterial({
        color: 0x0099ff,
        wireframe: true
    }));
    grabable.position.x = (Math.random() * 20) - 10;
...
//  cones
for (var i = 0; i < 20; i++) {
    const grabable = new THREE.Mesh(new THREE.CylinderGeometry(0, 1, 1, 5), new THREE.MeshBasicMaterial({
        color: 0xffcc00,
        wireframe: true
    }));
    grabable.position.x = (Math.random() * 20) - 10;
